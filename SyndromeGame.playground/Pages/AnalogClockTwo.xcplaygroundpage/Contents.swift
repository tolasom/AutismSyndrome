...
class MyClockTwoViewController : UIViewController{
    var counter = 0
    ...
    override func loadView() {
        ...
        analogClockTwo = UIButton(type: .system)
        analogClockTwo.setBackgroundImage(UIImage(named: "analog-image2"), for: .normal)
        ...
        view.addSubview(analogClockTwo)
        ...
        analogClockTwo.translatesAutoresizingMaskIntoConstraints = false
        ...
        analogClockTwo.topAnchor.constraint(equalTo: view.topAnchor, constant: 250),
        analogClockTwo.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 100),
        analogClockTwo.heightAnchor.constraint(equalToConstant: 190),
        analogClockTwo.widthAnchor.constraint(equalToConstant: 160),
...
PlaygroundPage.current.liveView = MyClockTwoViewController()
